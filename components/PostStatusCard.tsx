    ...
    <div className="card card-compact w-full bg-base-300 shadow-2xl p-2">
      <div className="card-body">
        ...
        <div className='flex justify-between '>
          ...
          <div className="flex justify-start mt-0 px-2 space-x-0">
            <div className='tooltip' data-tip="GIF">
              <div className='btn btn-square btn-md btn-ghost'>
            ...
            <div className='tooltip' data-tip="Media">
              <div className='btn btn-square btn-md btn-ghost'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7">
            ...
            <div className='tooltip' data-tip="Collect Module">
              <div className='btn btn-square btn-md btn-ghost'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7">
            ...
            <div className='tooltip' data-tip="Comment Mode">
              <div className='btn btn-square btn-md btn-ghost'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7">
          ...
          <div className='flex px-4 py-3'>
            <button className="btn btn-primary btn-sm w-40 justify-evenly">
